...
class ItemPopularDrinkAdapter(
    private val drinks: MutableList<Drinks>,
    private val listener: ItemDrinkListener): RecyclerView.Adapter<ItemPopularDrinkAdapter.ViewHolder>() {
    private lateinit var context: Context
    class ViewHolder(private val binding: ItemPopularDrinkBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val binding: ItemPopularDrinkBinding = DataBindingUtil.inflate(
            LayoutInflater.from(parent.context),
            R.layout.item_popular_drink, parent, false)
