...
data class Drinks (
    ...
    @SerializedName("strInstructionsDE") var strInstructionsDE : String,
    @SerializedName("strInstructionsFR") var strInstructionsFR : String,
    @SerializedName("strInstructionsIT") var strInstructionsIT : String,
